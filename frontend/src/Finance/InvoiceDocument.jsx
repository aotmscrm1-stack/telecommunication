  ...
  return (
    <div ref={ref} className="pdf-5page-container" style={{ width: '100%', maxWidth: '820px', margin: '0 auto' }}>
      ...
      <div style={pageContainerStyle}>
        ...
        <div style={headerStyle}>
          ...
          <div style={{ textAlign: 'center', fontSize: 12.5, color: '#111827' }}>
            <span><strong>Phone:</strong> +91 80199-42233</span>
            <span style={{ margin: '0 10px', color: '#9ca3af' }}>|</span>
            <span><strong>Email:</strong> <a href="mailto:hr@aotms.com" style={{ color: '#2563eb', textDecoration: 'underline' }}>hr@aotms.com</a></span>
          </div>
        </div>

        {/* Title: OFFER LETTER */}
        <div style={{ textAlign: 'center', marginBottom: '16px' }}>
          <span style={{ fontSize: '18px', fontWeight: '800', textDecoration: 'underline', color: '#000000', letterSpacing: '1px' }}>
            OFFER LETTER
          </span>
        </div>
        ...
        <div style={{ border: '1.5px solid #000000', marginTop: 10 }}>
          <div style={{ textAlign: 'center', fontWeight: 800, fontSize: 13.5, textTransform: 'uppercase', padding: '6px', borderBottom: '1.5px solid #000000', background: '#f3f4f6' }}>
            COMPENSATION PLAN
          </div>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12.5 }}>
            <tbody>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '7px 12px', fontWeight: 700, width: '40%', borderRight: '1.5px solid #000000' }}>Name</td>
                <td colSpan={2} style={{ padding: '7px 12px', fontWeight: 700 }}>{clientName}</td>
              </tr>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '7px 12px', fontWeight: 700, borderRight: '1.5px solid #000000' }}>Designation</td>
                <td colSpan={2} style={{ padding: '7px 12px' }}>{designation}</td>
              </tr>
              <tr style={{ fontWeight: 700, borderBottom: '1.5px solid #000000', background: '#e5e7eb' }}>
                <td style={{ padding: '7px 12px', borderRight: '1.5px solid #000000' }}>Components Category</td>
                <td style={{ padding: '7px 12px', textAlign: 'right', borderRight: '1.5px solid #000000', width: '30%' }}>Monthly</td>
                <td style={{ padding: '7px 12px', textAlign: 'right', width: '30%' }}>Annual</td>
              </tr>
              <tr style={{ fontWeight: 700, borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '7px 12px', borderRight: '1.5px solid #000000' }}>Total Gross CTC</td>
                <td style={{ padding: '7px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(monthlyCtc)}</td>
                <td style={{ padding: '7px 12px', textAlign: 'right' }}>{fmtCurrency(annualCtc)}</td>
              </tr>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>Basic Salary</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(basicMonthly)}</td>
      ...
      <div style={pageContainerStyle}>
        ...
        <div style={{ border: '1.5px solid #000000', marginBottom: 24 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12.5 }}>
            <tbody>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', width: '40%', borderRight: '1.5px solid #000000' }}>HRA</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000', width: '30%' }}>{fmtCurrency(hraMonthly)}</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', width: '30%' }}>{fmtCurrency(hraAnnual)}</td>
              </tr>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>Medical</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(medicalMonthly)}</td>
                <td style={{ padding: '6px 12px', textAlign: 'right' }}>{fmtCurrency(medicalAnnual)}</td>
              </tr>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>Conveyance</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(conveyanceMonthly)}</td>
                <td style={{ padding: '6px 12px', textAlign: 'right' }}>{fmtCurrency(conveyanceAnnual)}</td>
              </tr>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>Food Transport Allowance</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(foodMonthly)}</td>
                <td style={{ padding: '6px 12px', textAlign: 'right' }}>{fmtCurrency(foodAnnual)}</td>
              </tr>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>Incentive</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(incentiveMonthly)}</td>
                <td style={{ padding: '6px 12px', textAlign: 'right' }}>{fmtCurrency(incentiveAnnual)}</td>
              </tr>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>Dearness Allowance</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(daMonthly)}</td>
              ...
              {customEarnings.map((earn, idx) => (
                <tr key={idx} style={{ borderBottom: '1.5px solid #000000' }}>
                  <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>{earn.name}</td>
                  <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(earn.monthly)}</td>
              ...
              <tr style={{ fontWeight: 800, background: '#f3f4f6' }}>
                <td style={{ padding: '8px 12px', borderRight: '1.5px solid #000000' }}>Net Earnings</td>
                <td style={{ padding: '8px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(netMonthly)}</td>
        ...
        <div style={{ marginTop: 20 }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12.5, border: '1.5px solid #000000' }}>
            <tbody>
              <tr style={{ borderBottom: '1.5px solid #000000' }}>
                <td style={{ padding: '6px 12px', width: '40%', borderRight: '1.5px solid #000000' }}>Professional Tax (PT)</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000', width: '30%' }}>{fmtCurrency(ptMonthly)}</td>
                <td style={{ padding: '6px 12px', textAlign: 'right', width: '30%' }}>{fmtCurrency(ptAnnual)}</td>
              </tr>
              {customDeductions.map((ded, idx) => (
                <tr key={idx} style={{ borderBottom: '1.5px solid #000000' }}>
                  <td style={{ padding: '6px 12px', borderRight: '1.5px solid #000000' }}>{ded.name}</td>
                  <td style={{ padding: '6px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(ded.monthly)}</td>
              ...
              <tr style={{ fontWeight: 800, background: '#fee2e2' }}>
                <td style={{ padding: '7px 12px', borderRight: '1.5px solid #000000' }}>Total Deductions</td>
                <td style={{ padding: '7px 12px', textAlign: 'right', borderRight: '1.5px solid #000000' }}>{fmtCurrency(totalDeductionsMonthly)}</td>
      ...
      <div style={pageContainerStyle}>
        ...
        <div style={{ border: '1.5px solid #000000', padding: 16, background: '#f9fafb', marginBottom: 30 }}>
          ...
          <p style={{ margin: '0 0 14px 0', fontSize: 12.5, lineHeight: 1.5, textAlign: 'justify' }}>
            I, <strong>{clientName}</strong>, hereby accept the offer of employment as <strong>"{designation}"</strong> with AOTMS Global Private Limited on the terms and conditions outlined in this offer letter (Pages 1 to 5). I confirm that I will join duty on <strong>{offerDate}</strong> and agree to abide by all the rules, regulations, policies, and procedures of the company as amended from time to time.
          </p>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginTop: 24, paddingTop: 16, borderTop: '1.5px solid #000000' }}>
            <div>
              ...
              <div style={{ fontSize: 12, color: '#4b5563', marginTop: 4 }}>Place: ________________________</div>
            </div>

            <div style={{ textAlign: 'right' }}>
              <div style={{ fontWeight: 800, fontSize: 13, color: '#000000' }}>For AOTMS GLOBAL PRIVATE LIMITED</div>
              <div style={{ fontFamily: "'Brush Script MT', cursive", fontSize: 24, color: '#0f172a', fontWeight: 'bold', margin: '8px 0' }}>
                Deenaz Shaik
              </div>
              <div style={{ fontWeight: 700, fontSize: 13, color: '#1e293b' }}>Deenaz Shaik</div>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#475569' }}>HR Manager</div>
            </div>
          </div>
        </div>
